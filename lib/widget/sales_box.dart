    ...
    return Column(
      children: <Widget>[
        Container(
          ...
          decoration: BoxDecoration(
            border: Border(bottom: BorderSide(width: 1, color: Color(0xffff2f2)))
          ),
          child: Row(
  ...
  Widget _item(BuildContext context, CommonModel model, bool big, bool left , bool last){
    ...
    return  GestureDetector(
        onTap: (){
          Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => WebView(url: model.url, statusBarColor: model.statusBarColor,
